...
== {CD} integration to chef

This plugin interacts with the Chef shell through the {CD} agent. You can perform different actions using the Chef utility to get the same results as when using a command-line interface. This plugin includes procedures that
