...
+
NOTE: Although the *CreateCookbook > Readme format* parameter has been deprecated, it still exists in the UI so breaking changes are not introduced in existing project automations.
