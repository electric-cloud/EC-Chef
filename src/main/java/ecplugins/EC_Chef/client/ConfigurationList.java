    ...
    extends ListBase
{
    ...
    private ChefConfigList m_configList;

    //~ Constructors -----------------------------------------------------------

    public ConfigurationList()
    {
        super("ecgc", "Chef Configurations", "All Configurations");
        m_configList = new ChefConfigList();
    }
    ...
    @Override protected void load()
    {
        ...
        ChefConfigListLoader loader = new ChefConfigListLoader(m_configList, this,
                new ChainedCallback() {
    ...
    private void deleteConfiguration(String configName)
    {
        ...
        request.setProjectName("/plugins/EC-Chef/project");
    ...
    private void loadList()
    {
        ...
        if (!m_configList.isEmpty()) {
            listTable.addHeaderRow(true, "Configuration Name", "Server URL", "Description");
        }
        ...
        for (String configName : m_configList.getConfigNames()) {
            ...
            // Description
            String configDescription = m_configList.getConfigDescription(configName);
            Label  configDescriptionLabel = new Label(configDescription);
            ...
            DialogClickHandler dch              = new DialogClickHandler(
                    new DeleteConfirmationDialog(configName,
                        "Are you sure you want to delete the Chef configuration '"
                            + configName + "'?") {
            ...
            listTable.addRow(configNameLabel, configServerLabel, configDescriptionLabel, actions);
        }
